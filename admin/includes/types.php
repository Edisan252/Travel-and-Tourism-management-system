...
$sql="INSERT INTO tbltourpackages(PackageName,PackageType,number_of_pepole,PackageLocation,PackagePrice,PackageFetures,PackageDetails,PackageImage) VALUES(:pname,:ptype,:nu_pepole,:plocation,:pprice,:pfeatures,:pdetails,:pimage)";
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="horizontal-form">
                            <form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label"> Number of Maximum Pepole's </label>
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control1" name="n_pepoles" id="packagetype"
