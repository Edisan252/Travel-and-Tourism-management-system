...
$sql="INSERT INTO tbltourpackages(PackageName,PackageType,number_of_people,limit_of_people,PackageLocation,PackagePrice,PackageFetures,PackageDetails,PackageImage) VALUES(:pname,:ptype,:limit_of,:nu_pepole,:plocation,:pprice,:pfeatures,:pdetails,:pimage)";
                ...
                <div class="grid-form1">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="horizontal-form">
                            <form class="form-horizontal" name="package" id="packageForm" method="post"
                                ...
                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label"> Number of Maximum Pepole's
                                    </label>
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control1" name="limit_of" id="groupSize"
                                            placeholder="Maximum Pepole's for this package" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">Limit of The Batch
                                    </label>
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control1" name="n_pepoles" id="batchLimit"
                                            placeholder="Maximum Limit of The Batch" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-8 col-sm-offset-2">
                                        <button type="submit" id="submitButton" disabled name="submit"
...
document.getElementById("packageForm").addEventListener("input", function() {
    ...
    var batchLimit = parseInt(document.getElementById("batchLimit").value);
    var submitButton = document.getElementById("submitButton");

    if (isNaN(groupSize) || isNaN(batchLimit)) {
        submitButton.disabled = true;
    } else {
        if (batchLimit <= groupSize) {
